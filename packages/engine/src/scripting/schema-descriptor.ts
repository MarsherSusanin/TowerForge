...
export const TOWER_SCRIPT_TARGETS = Object.freeze({
  entity: ["self", "eventEnemy", "eventTower", "allEnemies", "allTowers"] satisfies TowerScriptEntityTarget[],
  enemy: ["self", "eventEnemy", "allEnemies"] satisfies TowerScriptEntityTarget[],
  tower: ["self", "eventTower", "allTowers"] satisfies TowerScriptEntityTarget[]
});
...
} satisfies Record<TowerScriptEventName, string[]>);
